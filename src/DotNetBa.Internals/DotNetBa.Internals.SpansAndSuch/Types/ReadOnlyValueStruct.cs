...
{
    public readonly struct ReadOnlyValueStruct
    {
        public ReadOnlyValueStruct(int value1, int value2, int value3, int value4, double value5, double value6, double value7, double value8)
        {
            Value1 = value1;
            Value2 = value2;
            Value3 = value3;
